...
-- 🔱 GLYPH CIRCLE: ADMINISTRATIVE COMMAND & CONTROL (FINAL)
-- Run this in your Supabase SQL Editor.

-- 1. Identity Verification (JWT-based)
-- Checks the JWT app_metadata role without touching the users table to prevent recursion loops.
...
-- 2. Performance Bundle (Fixes the 404 console error)
-- Fetches all active configs and content in one atomic request.
...
-- 3. The Admin Batch CRUD Engine
-- Dynamically updates any table using a service-role context.
