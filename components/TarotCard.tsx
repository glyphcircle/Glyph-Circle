// TarotCard.tsx - FIXED: Component documentation and optimization
// Description: Individual Tarot card component with flip animation and themed styling
// Features:
// 1. Card flip animation: Reveals card face when selected (rotate-y-180)
// 2. Themed styling: Major Arcana (purple/gold) vs Minor Arcana (suit colors)
// 3. Sacred geometry: Animated back design with eye symbol
// 4. Image support: Custom artwork or fallback CSS crystal ball with emoji icons
// 5. Responsive sizing: Adapts text/icons for mobile/tablet/desktop
// 6. Performance: Memoized theme calculation, optimized re-renders
// 7. Haptic feedback: Vibration on card selection (mobile devices)
// Status: ✅ READY TO USE (No back button - child component of Tarot.tsx)
...
// ============================================================
// THEME GENERATOR - MAJOR VS MINOR ARCANA STYLING
// ============================================================

const getCardTheme = (card: TarotCardData) => {
  // 1. MAJOR ARCANA (Purple/Gold theme)
  if (card.type === 'Major') {
    return {
  ...
  switch (suit) {
    ...
    case 'Pentacles': // Earth (Green/Emerald)
      return {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ==============================
            FRONT (Card Back - Before Selection)
           ============================== */}
        <div
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center z-20">
            <div className="w-1/3 aspect-square rounded-full border border-amber-500/30 flex items-center justify-center relative bg-black/60 backdrop-blur-sm shadow-[0_0_15px_rgba(245,158,11,0.2)] transition-all duration-500 group-hover:shadow-[0_0_25px_rgba(245,158,11,0.5)] group-hover:scale-110">
              ...
              <span className="text-[150%] filter drop-shadow-[0_0_5px_rgba(245,158,11,0.8)] opacity-90 transition-transform duration-500 group-hover:rotate-12">
                👁️
              </span>
            </div>
          </div>
        ...
        {/* ==============================
            BACK (Card Face - After Selection)
           ============================== */}
        <div
          className={`
        ...
        >
          ...
          <div className="relative z-10 flex-grow flex items-center justify-center w-full min-h-0 py-2">
            ...
            {card.image ? (
              ...
              /* Option B: CSS Crystal Ball Fallback (Default) */
              <div className="relative w-[85%] aspect-square flex items-center justify-center max-h-full">
                ...
                <div className="relative w-full h-full rounded-full bg-gradient-to-br from-white/10 to-transparent border border-white/20 shadow-inner flex items-center justify-center overflow-hidden backdrop-blur-sm group-hover:scale-105 transition-transform duration-700">
                  ...
                  <div className="relative z-10 w-full h-full flex items-center justify-center filter drop-shadow-lg transform leading-none">
                    <span className="text-[3em] sm:text-[4em] md:text-[5em] filter drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                      {theme.icon}
                    </span>
                  </div>
