// ReferralProgram.tsx - FIXED: Back button z-index
// Changes:
// 1. Back button: Added z-[70] relative shadow-lg (sits ABOVE GamificationHUD z-20)
// 2. No payment flow in this component (referral sharing interface)
// 3. Referral code generation and sharing maintained
// Status: ✅ READY TO USE
...
const ReferralProgram: React.FC = () => {
    ...
    // Fixed base URL logic for blob origin environments
                ...
                <Card className="bg-gradient-to-b from-gray-900 to-black border-amber-500/30 overflow-hidden">
                    <div className="p-8 text-center">
                        ...
                        <div className="bg-gray-800/50 border border-amber-500/30 rounded-xl p-6 mb-8 relative group">
                            ...
                            <div
                                className="text-3xl font-mono font-bold text-amber-400 tracking-wider select-all cursor-pointer"
                                onClick={() => {
