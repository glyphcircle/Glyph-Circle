// Leaderboard.tsx - FIXED: Back button z-index
// Changes:
// 1. Back button: Added z-[70] relative shadow-lg + proper SVG icon (sits ABOVE GamificationHUD z-20)
// 2. No payment flow in this component (displays leaderboard rankings)
// 3. Mock data for social proof maintained
// Status: ✅ READY TO USE
        ...
        <div className="min-h-screen py-8 px-4">
            <div className="max-w-2xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <Link
                        to="/home"
                        className="inline-flex items-center text-amber-200 hover:text-amber-400 transition-colors group relative z-[70] shadow-lg"
                    >
                        <svg
