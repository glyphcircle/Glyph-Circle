...
const Login: React.FC = () => {
  ...
  const [mode, setMode] = useState<'form' | 'phone' | 'otp' | 'register'>('form');
  ...
  return (
    <div className={`flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-4 pb-12 transition-colors duration-500 font-lora ${isLight ? 'bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50' : 'bg-black'
      ...
      <div className={`w-full max-w-md border rounded-2xl shadow-2xl overflow-hidden backdrop-blur-2xl animate-fade-in-up transition-all ${isLight ? 'bg-white/90 border-amber-200' : 'bg-gray-900/60 border-amber-500/20'
        }`}>
        <div className="p-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 italic text-[10px] uppercase mt-2 tracking-[0.3em]">
              {mode === 'register' ? 'Join the Cosmic Circle' : 'Authorized Personnel Only'}
            </p>
          </div>
